  ...
  return (
    <div className='desktop:bg-eggshell desktop:p-24'>
      <div className="bg-white desktop:rounded-3xl desktop:mx-64 desktop:pt-6">
        <img src={omeletteImg} alt="" className='mx-auto desktop:rounded-2xl desktop:scale-desktop '/>
        <div>
          ...
          <div className='bg-rose-white font-outfit m-8 p-3 rounded-lg'>
            <h3 className='font-semibold text-dark-raspberry text-xl m-3 desktop:m-2'>Preparation time</h3>
